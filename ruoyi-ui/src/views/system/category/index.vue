<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="内容处理策略" prop="handleId">
        <el-input
          v-model="queryParams.handleId"
          placeholder="请输入内容处理策略"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="内容处理策略" align="center" prop="handleId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="内容处理策略" prop="handleId">
          <el-input v-model="form.handleId" placeholder="请输入内容处理策略" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        handleId: [
          { required: true, message: "内容处理策略不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除内容分类编号为"' + ids + '"的数据项？').then(function() {
